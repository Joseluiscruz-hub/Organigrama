...
@Component({
  ...
  template: `
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4" aria-modal="true" role="dialog">
      ...
      <!-- Modal Content -->
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden relative transform transition-all animate-slideUp z-10">
        ...
        <div [class]="'h-24 relative ' + roleConfig().color">
          ...
          <div class="absolute -bottom-10 left-8">
            <div class="w-24 h-24 bg-white rounded-full p-1.5 shadow-xl">
        ...
        <div class="pt-14 pb-8 px-8">
          <div class="flex justify-between items-start">
            <div>
              ...
              <p class="text-slate-500 font-medium">{{ employee().role }}</p>
            ...
            <div class="text-right">
              <p class="text-xs text-slate-400 uppercase tracking-wider font-semibold">ID Corp</p>
              <p class="font-mono font-bold text-slate-700 text-lg">{{ employee().id }}</p>
            </div>
          </div>
          ...
          <div class="mt-8 grid grid-cols-2 gap-4">
            <div class="bg-slate-50 p-4 rounded-xl border border-slate-100">
              ...
              <p class="text-2xl font-bold text-indigo-600">{{ employee().performance }}%</p>
            </div>
            <div class="bg-slate-50 p-4 rounded-xl border border-slate-100">
              <div class="flex items-center text-slate-500 mb-2">
              ...
              <p class="text-2xl font-bold text-indigo-600">{{ employee().years }} <span class="text-sm text-slate-400 font-normal">Años</span></p>
            </div>
          </div>

          <div class="mt-8 space-y-4">
            <div class="flex items-center text-slate-700 p-2 hover:bg-slate-50 rounded-lg transition-colors">
              <div class="bg-slate-100 p-2 rounded-full mr-3 text-slate-500">
          ...
          <div class="mt-8 pt-6 border-t border-slate-100 flex justify-end">
            <button 
              (click)="close()"
              class="px-5 py-2.5 bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition shadow-lg hover:shadow-xl font-medium text-sm flex items-center"
            >
