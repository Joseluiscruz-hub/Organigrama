...
export class DataService {
  ...
  generateData(): AppData {
    ...
    const createEmployee = (roleKey: RoleKey, blockId: number, specificRoleTitle: string | null = null, specificName: string | null = null): Employee => {
      ...
      const employeeName = specificName || `${randomFirst} ${randomLast}`;
    ...
    return {
      manager: createEmployee('GERENTE', 0, 'Gerente de Operaciones', 'Jorge Mateos'),
      blocks,
